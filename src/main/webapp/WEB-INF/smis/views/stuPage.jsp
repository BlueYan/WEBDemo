...
<table width="40%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td colspan="5" align="center">
            ...
            <a href="/Student?cmd=page&currentPage=1">首页</a>
            <a href="/Student?cmd=page&currentPage=${stuResult.prePage}">上一页</a>
            <%
                PageResult<Student> stuResult = (PageResult<Student>) request.getAttribute("stuResult");
                System.out.println("currentPage = " + stuResult.getCurrentPage());
            %>
            <c:forEach begin="${stu.currentPage}" end="${stu.currentPage + 4}" step="1" var="index">
                <a href="/Student?cmd=page&currentPage=${index}">${index}</a>
            </c:forEach>
            <a href="/Student?cmd=page&currentPage=${stuResult.nextPage}">下一页</a>
            <a href="/Student?cmd=page&currentPage=${stuResult.totalPage}">尾页</a>
        </td>
    </tr>
</table>
